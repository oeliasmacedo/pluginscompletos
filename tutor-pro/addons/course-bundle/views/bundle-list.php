...
try {
	$add_new_url = Utils::construct_page_url( BundleBuilder::ACTION_TYPE_ADD );
} catch ( \Throwable $th ) {
	tutor_log( $th );
	$add_new_url = '';
}
...
$navbar_data = array(
	...
	'button_url'   => '#',
	'button_class' => 'tutor-add-new-course-bundle',
);
					...
					<tbody>
						<?php if ( $the_query->have_posts() ) : ?>
							...
							foreach ( $the_query->posts as $key => $post ) :
								...
								try {
									$edit_url = Utils::construct_page_url( 'edit', $post->ID );
								} catch ( \Throwable $th ) {
									tutor_log( $th );
									$edit_url = '';
								}
								...
								<tr>
									...
									<td>
										<div class="tutor-d-flex tutor-align-center tutor-gap-2">
											<a href="<?php echo esc_url( $edit_url ); ?>" class="tutor-d-block">
											...
											<div>
												<a class="tutor-table-link" href="<?php echo esc_url( $edit_url ); ?>">
										...
										<div class="tutor-d-flex tutor-align-center tutor-justify-end tutor-gap-2">
											...
											<div class="tutor-dropdown-parent">
												...
												<div id="table-dashboard-course-list-<?php echo esc_attr( $post->ID ); ?>" class="tutor-dropdown tutor-dropdown-dark tutor-text-left">
													...
													<a class="tutor-dropdown-item" href="<?php echo esc_url( $edit_url ); ?>">
