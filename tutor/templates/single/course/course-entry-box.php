...
<div class="tutor-card tutor-card-md tutor-sidebar-card">
	...
	<div class="tutor-card-body">
		...
		if ($is_enrolled || $is_privileged_user) {
			...
			// The course requires purchase and is not public.
			...
			if (tutor_utils()->is_course_fully_booked(null)) {
				...
				// Exibe preços personalizados e o botão para assinatura anual
				ob_start();

				// Preço promocional sendo apenas como exemplo; substitua pelo valor real
				$promotional_price = 'R$ 199,00'; // Use aqui o método real para obter o preço promocional
				?>
				<div class="tutor-course-pricing">
					<div class="tutor-fs-4 tutor-fw-bold tutor-color-black">
						<?php echo esc_html($promotional_price); ?>
					</div>
					<div class="tutor-course-original-price tutor-fs-6 tutor-color-muted">
						<?php esc_html_e('Incluso no Plano Anual', 'seu-text-domain'); ?>
					</div>
				</div>

				<!-- Botão para assinatura anual -->
				<a href="https://app.reencontrando.com.br/assinatura-plano-anual"
				   class="tutor-btn tutor-btn-primary tutor-btn-lg tutor-btn-block tutor-mt-24">
					<?php esc_html_e('ASSINAR PLANO ANUAL', 'seu-text-domain'); ?>
				</a>
				<?php
					...
					<div class="tutor-course-single-btn-group <?php echo is_user_logged_in() ? '' : 'tutor-course-entry-box-login'; ?>" data-login_url="<?php echo esc_url($login_url); ?>">
						<form class="tutor-enrol-course-form" method="post">
							...
							<button type="submit" class="tutor-btn tutor-btn-primary tutor-btn-lg tutor-btn-block tutor-mt-24 tutor-enroll-course-button tutor-static-loader">
								<?php esc_html_e('Inscreva-se', 'tutor'); ?>
							</button>
						</form>
					</div>
